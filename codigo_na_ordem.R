...
jacobiano<-matrix(c(H22,H23,N22,H32,H33,N32,M22,M23,L22),byrow = T, nrow = 3)
jacobiano
inv_jacobiano = solve(jacobiano)
v_t = inv_jacobiano %*% deltas
v_t
